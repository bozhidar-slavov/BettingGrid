...
namespace BettingGrid.API.Migrations
{
    ...
    [Migration("20200304183650_AddedNewRecordInEventsTable")]
    partial class AddedNewRecordInEventsTable
    {
            ...
            modelBuilder.Entity("BettingGrid.API.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HomeSideOdds = 2.80m,
                            StartDate = new DateTime(2020, 3, 9, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            HomeSideOdds = 4.50m,
                            StartDate = new DateTime(2020, 4, 3, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 3,
                        ...
                        new
                        {
                            ...
                            HomeSideOdds = 2.30m,
                            StartDate = new DateTime(2020, 3, 12, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            HomeSideOdds = 3.20m,
                            StartDate = new DateTime(1982, 3, 4, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
